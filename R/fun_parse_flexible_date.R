parse_flexible_date <- function(date_str) {
  ...
  # Try 4-digit year formats only when the string actually contains a 4-digit sequence.
  # Without this guard, %Y greedily matches 2-digit years (e.g. "6/20/21" → year 21 AD).
  ...
  # 2-digit year formats as fallback
