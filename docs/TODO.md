...
- [x] no culex status dropped
- [x] culex_clean_all_spp_plot.png only showing tarsalis and pipiens should still be all species 
- [x] ensure traps are uppercase for merging with list.
- [ ] create matching list for old to new trap names. potentially add to foco_trap database
- [ ] malfunction_trap_wks: 21 should be number of malfunctions and it looks low

## wnv-s_clean()
### desc: current summary isn't the most informative
- [x] create new summary 
